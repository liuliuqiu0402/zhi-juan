...
// 两音**略有重叠**（咚起时叮仍在余韵中），且间隔拉到 0.42s、衰减放缓 → "叮……咚"的钟感与更足的响度
const DING = { freq: 1318.5, at: 0, dur: 0.75, amps: [1.0, 0.42, 0.28, 0.10], decays: [5.5, 8.5, 12, 17] };
const DONG = { freq: 1046.5, at: 0.42, dur: 0.98, amps: [0.95, 0.40, 0.26, 0.09], decays: [4.5, 7, 10, 14] };
const TOTAL = 1.40;
