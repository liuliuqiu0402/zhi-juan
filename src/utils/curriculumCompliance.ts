...
// 学科核心素养关键词（与 qualityChecker COMPETENCY_TERMS 同源）
const COMPETENCY_TERMS = {
  '语文': { primary: ['识字与写字', '阅读与鉴赏', '表达与交流', '文化自信', '语言运用', '思维能力', '审美创造'], middle: ['语言积累', '阅读与鉴赏', '表达与交流', '整本书阅读', '思辨性阅读'], high: ['语言建构', '思维发展', '审美鉴赏', '文化传承', '学习任务群'] },
  '数学': { middle: ['数学抽象', '逻辑推理', '数学建模', '直观想象', '数学运算', '数据分析'], high: ['数学抽象', '逻辑推理', '数学建模', '直观想象', '数学运算', '数据分析'] },
  '英语': { middle: ['语言能力', '文化意识', '思维品质', '学习能力'], high: ['语言能力', '文化意识', '思维品质', '学习能力'] },
  '物理': { middle: ['物理观念', '科学思维', '科学探究', '科学态度'], high: ['物理观念', '科学思维', '科学探究', '科学态度'] },
  '化学': { middle: ['宏观辨识', '变化观念', '证据推理', '科学探究'], high: ['宏观辨识', '变化观念', '证据推理', '科学探究'] },
  '生物': { middle: ['生命观念', '科学思维', '科学探究', '社会责任'], high: ['生命观念', '科学思维', '科学探究', '社会责任'] },
  '历史': { middle: ['唯物史观', '时空观念', '史料实证', '历史解释', '家国情怀'], high: ['唯物史观', '时空观念', '史料实证', '历史解释', '家国情怀'] },
  '地理': { middle: ['人地协调观', '综合思维', '区域认知', '地理实践力'], high: ['人地协调观', '综合思维', '区域认知', '地理实践力'] },
  '道德与法治': { middle: ['政治认同', '道德修养', '法治观念', '健全人格', '责任意识'], high: ['政治认同', '道德修养', '法治观念', '健全人格', '责任意识'] },
  '思想政治': { high: ['政治认同', '科学精神', '法治意识', '公共参与'] },
};
...
export function assessCompliance(content, subject, stageSeg, genType = '') {
  ...
  const hasInfer = INFER_WORDS.some(w => questionText.includes(w));
