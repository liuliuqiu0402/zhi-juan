...
const TOPIC_CLUSTERS = [
  { topic: '图书/阅读活动', words: /图书角|图书|书架|书店|图书馆|阅览室|绘本|科普书|故事书|读书活动|捐书|借书/ },
  { topic: '校内集体活动', words: /义卖|募捐|捐赠|献爱心|文艺演出|文艺汇演|合唱(?:队|演出)?|大扫除|值日|布置教室|运动会|接力赛|拔河|广播操/ },
  { topic: '食堂餐饮', words: /食堂|午餐|就餐|饭堂|餐费|伙食/ },
  { topic: '运动比赛', words: /赛跑|游泳|跳远|跳高|篮球赛|足球赛|羽毛球|乒乓球|跑步比赛|米决赛/ },
  { topic: '出行旅游', words: /旅行|旅游|出游|自驾|坐车|乘车|车站|高铁|航班|景区|景点|路程|每小时行/ },
  { topic: '超市购物', words: /超市|商场|购物|单价|促销|特价|折扣|付款|收银|买菜|买鱼|买肉|买水果/ },
  { topic: '家庭生活', words: /包饺子|做饭|家务|洗衣服|打扫卫生|买(?:菜|米|油)|水电费|电费|水费/ },
  { topic: '农业生产', words: /农场|果园|菜地|种植|菜园|鱼塘|养殖|收(?:获|割)|亩产|植树|树苗/ },
];
