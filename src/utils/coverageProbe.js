...
export const BEHAVIOR_TERMS = [
  ...
  '竖式', '计算', '列式', '运算',
  // 🔧 语言/表达类行为承载（2026-09 对账内容口径·英语等外语学科）：考点以语言行为呈现时，
  //    正文不逐字出现中文考点名（如"鼓励他人的表达"正文是 You can do it!/Keep trying!、
  //    "一般过去时叙事结构"正文是 First/Then/Finally）——归章级聚合，由 specificConcepts
  //    （教材原文语言例词）承担词面命中；不逐条中文精确报缺。
  //    ⚠️ 只收录外语/语用安全的词：不收录 结构/文化/功能 等与生物（细胞的结构）、历史（xx文化）
  //    等理科/文科精确概念考点共用的词——那些概念须精确报缺，误放行为章级会造成漏检。
  '表达', '交流', '交际', '句式', '句型', '语法', '时态', '语音', '诵读', '语篇', '话题', '写作', '习作',
  '叙事', '叙述', '描述',
];
