 ...
 *  🔴 2026-09-13（用户定版·下限非上限）：清单定位由"命题范围边界"改为"覆盖下限"——
 *     覆盖是**下限**（清单考点须全部覆盖到，保证本单元必学点不漏），但**不是上限**（可依课标学段学业要求
 *     补充清单未涉及的考点或角度）。原"最小单位**一律**是考点"的"一律"易被读成"只能考清单内的点"，已去。 */
export const ANCHOR_LIST_ROLE_NOTE =
  ...
  + '🔴 清单是**覆盖下限、不是命题上限**：清单内考点须全部覆盖到（保证本单元必学知识不漏），也可依本学段课标学业要求，'
  + '适当补充清单未涉及的考点或考查角度（不超出本学段学业要求）。';
