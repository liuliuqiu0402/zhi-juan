...
//    A 系列标准纸横向拼接 = 整张 A4 单元并排（A3=2 张、A2=3 栏、A1=4 张 A4）：
//    - A3（297×420mm 横向）：高考语文/数学/综合科目试卷与答题卡，两栏
//    - A2（420×594mm 横向 594×420）：三栏大试卷，每栏可用宽 ≈ A4（≥A4 口径，内容无需重排）
//    - A1 四栏 = 4 张 A4 竖放并排（840×297，用户规格 2026-08）：每栏 = 整张 A4 版面（210 宽×297 高）
...
export const PAPER_PRESETS = {
  ...
  'a1-4col': { label: '4×A4 并排四栏（840×297）', wMm: 840, hMm: 297, cols: 4, gapMm: 12 },
