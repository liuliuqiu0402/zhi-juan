...
export const TEACHING_BLUEPRINTS = {
  ...
  practice: {
    label: '同步练习',
    sections: [
      { name: '基础建构', note: '学习理解类活动（感知与注意、获取与梳理、概括与整合）' },
      { name: '探究进阶', note: '应用实践类活动（描述与阐释、分析与判断、内化与运用）' },
      { name: '迁移创新', note: '迁移创新类活动（推理与论证、批判与评价、想象与创造）' },
    ],
    stages: {
...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  '语文': {
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '学习理解（识字与写字、语言积累与梳理）：涉及本次范围核心字词句段知识，围绕识字与写字、阅读与鉴赏、表达与交流、梳理与探究四类语文实践活动组织（按本次范围内容取适用类项），在语境中考查' },
        { name: '探究进阶', note: '应用实践（阅读与鉴赏、表达与交流）：语段阅读与表达运用' },
        { name: '迁移创新', note: '迁移创新（表达与交流、梳理与探究）：口语表达或写话，联系本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
  ...
  '数学': {
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '了解、理解（会用数学的眼光观察现实世界）：涉及本次范围核心知识点，在情境中考查' },
        { name: '探究进阶', note: '掌握、运用（会用数学的思维思考现实世界）' },
  ...
  '英语': {
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '学习理解类活动（感知与注意、获取与梳理、概括与整合）：涉及本次范围核心内容，在情境中呈现' },
        { name: '探究进阶', note: '应用实践类活动（描述与阐释、分析与判断、内化与运用）：语篇语境中的综合运用' },
        { name: '迁移创新', note: '迁移创新类活动（推理与论证、批判与评价、想象与创造）：真实交际运用（情境对话、介绍、交流），联系本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
  ...
  '历史': {
    ...
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '时空观念与史实理解：涉及本次范围史实、时间、人物等核心内容，在时间轴/地图情境中考查' },
  ...
  '道德与法治': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '道德修养与认知：涉及本次范围行为规范与道德知识等核心内容，在情境辨析中考查' },
  ...
  '信息科技': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '信息意识与概念理解：涉及本次范围概念与原理等核心内容，在应用场景中考查；概念与原理须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械记忆或仅作情境背景代替概念考查' },
  ...
  '体育': {
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶', note: '运动能力运用（运用与组合）：技能运用与组合题目' },
