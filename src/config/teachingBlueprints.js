...
export const TEACHING_BLUEPRINTS = {
  ...
  practice: {
    label: '同步练习',
    sections: [
      { name: '基础建构任务', note: '学习理解类活动（感知与注意、获取与梳理、概括与整合）：覆盖本次范围全部核心知识，基础内容为主，各题/任务在情境中完整可作答' },
      { name: '探究进阶任务', note: '应用实践类活动（描述与阐释、分析与判断、内化与运用）：变式与综合运用，换情境、换角度、换设问，考查迁移运用，各题/任务步骤清晰' },
      { name: '迁移创新任务', note: '迁移创新类活动（推理与论证、批判与评价、想象与创造）：开放性/实践性内容，联系真实生活，设问指向真实思维' },
    ],
    stages: {
      primary_low: { volume: '6-9题', note: '以感知与体验为主：认读、口答、圈画等操作型任务，情境具体直观，图文并茂' },
      primary_mid: { volume: '8-12题', note: '以理解与运用为主：任务以真实生活情境为主，书写与表达适度兼顾' },
      primary_high: { volume: '10-15题', note: '以综合运用与初步创新为主：增加开放性任务，鼓励多角度思考与表达' },
      middle: { volume: '8-12题', note: '以探究与实践为主：任务含过程性要求，步骤完整、书写规范' },
      high: { volume: '10-15题', note: '以迁移与创新为主：任务指向综合运用，设问有层次、可思辨' },
    },
  },
  ...
  special: {
    label: '专项突破',
    sections: [
      { name: '分板块组织', note: '按知识层级分板块（每个板块一个知识层级），板块内设问有合理梯度、由浅入深（学习理解→应用实践→迁移创新），层次依内容自然形成' },
      { name: '每板块配解析', note: '每板块适量题目并附解析（讲明错因、避免与正确思路），聚焦本单元薄弱点' },
    ],
    stages: {
      primary_low: { volume: '每板块3-4题，2-3板块', note: '以感知与体验为主：板块短小，情境游戏化，便于口头作答' },
      primary_mid: { volume: '每板块3-5题，2-4板块', note: '以理解与运用为主：板块围绕本单元内容，题目以情境为载体' },
      primary_high: { volume: '每板块4-5题，3-4板块', note: '以综合运用与初步创新为主：板块含综合变式，设问开放' },
      middle: { volume: '每板块3-5题，3-4板块', note: '以探究与实践为主：板块含过程性设问，注重步骤与推理' },
      high: { volume: '每板块4-6题，3-5板块', note: '以迁移与创新为主：板块设问有区分度，指向综合运用' },
    },
  },
  ...
  preview: {
    ...
    sections: [
      ...
      { name: '预习任务', note: '分层（由浅入深：感知体验→理解建构→尝试运用），问题驱动（圈画/概括/查阅/尝试），每任务给做法与完成标准，可操作可检查，覆盖本次范围全部新知识点' },
  ...
  reading: {
    ...
    sections: [
      ...
      { name: '分层设题', note: '设问由浅入深（理解字面→推断隐含→评价迁移），指向理解运用与整体感受，题目不可直接在原文找到现成字面答案' },
    ],
    stages: {
  ...
  summary: {
    ...
    stages: {
      primary_low: { volume: '正文300-500字', note: '以感知与体验为主：多用图表与图示，图文并茂' },
      primary_mid: { volume: '正文500-800字', note: '以理解与运用为主：知识框架结构化呈现，条目清晰' },
      primary_high: { volume: '正文800-1200字', note: '以综合运用与初步创新为主：含易错辨析，结构清晰' },
      middle: { volume: '正文800-1200字', note: '以探究与实践为主：含规律与方法归纳' },
      high: { volume: '正文1200-1800字', note: '以迁移与创新为主：含知识网络梳理，呈现结构化' },
    },
  },
  ...
  dictation: {
    label: '默写积累',
    sections: [
      { name: '基础默写', note: '本次范围要求掌握的基础内容，置于语境或情境中呈现（不孤立罗列），含易错点' },
      { name: '积累内容', note: '严格对应教材要求，覆盖全部要求掌握的内容，按学段体现层次（感知记忆→理解运用→综合迁移）' },
      { name: '书写呈现', note: '书写载体按学科与学段规范呈现，由系统渲染' },
    ],
    stages: {
      primary_low: { volume: '基础内容4-8条', note: '以感知与体验为主：以本次范围核心内容为主，量小而精' },
      primary_mid: { volume: '基础内容8-12条', note: '以理解与运用为主：内容在语境或情境中呈现，覆盖单元要求' },
      primary_high: { volume: '基础内容12-18条', note: '以综合运用与初步创新为主：覆盖单元全部要求掌握的内容，含易错点' },
      middle: { volume: '基础内容12-16条', note: '以探究与实践为主：内容在情境中考查，含易错辨析' },
      high: { volume: '基础内容15-20条', note: '以迁移与创新为主：覆盖要求内容，含综合情境考查' },
    },
  },
  ...
  errorbook: {
    ...
    sections: [
      ...
      { name: '错因剖析', note: '具体到知识点或思维环节，归因明确，不写空泛套话' },
      { name: '正确解答', note: '分步完整解答，讲透解题思路' },
      { name: '方法提炼', note: '归纳本类题可迁移的通用策略' },
      { name: '变式训练', note: '每题 1 道变式（换情境、换设问角度，不复刻本题思路）' },
    ],
    stages: {
      primary_low: { volume: '4-6题', note: '以感知与体验为主：按知识点或错因分类，每题结构完整' },
      primary_mid: { volume: '5-8题', note: '以理解与运用为主：归因明确，变式贴近本题' },
      primary_high: { volume: '6-10题', note: '以综合运用与初步创新为主：归因具体，变式换情境换设问' },
      middle: { volume: '6-10题', note: '以探究与实践为主：归因具体到知识模块，变式换角度' },
      high: { volume: '8-12题', note: '以迁移与创新为主：含方法性归因与迁移策略，变式有区分度' },
    },
  },
  ...
  review: {
    ...
    sections: [
      ...
      { name: '核心知识梳理', note: '按知识层级分层（学习理解→应用实践→迁移创新）逐条梳理（标注教材出处），重点难点突出' },
      { name: '典型题析', note: '典型题（含解题思路剖析，不只看式复现）' },
      { name: '易错聚焦', note: '易错点辨析，具体到易混处并给正确思路' },
      { name: '综合自测', note: '自测（基础/提高），按知识层级分布，覆盖本单元全部知识点' },
    ],
    stages: {
      primary_low: { volume: '自测8-12题', note: '以感知与体验为主：框架简明，自测题情境化、图文并茂' },
...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  '语文': {
    practice: {
      ...
      sections: [
        ...
        { name: '探究进阶任务', note: '应用实践层（阅读与鉴赏、表达与交流）：语段阅读与表达运用，变式设问，考查知识迁移' },
    ...
    errorbook: {
      ...
      sections: [
        { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
        { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
        { name: '错因剖析', note: '具体到知识点或思维环节，归因明确' },
        { name: '正确解答', note: '分步完整解答' },
        { name: '方法提炼', note: '归纳本类题通用策略' },
        { name: '变式训练', note: '1 道变式（换情境、换设问角度）' },
      ],
    },
    review: {
      label: '复习资料',
  ...
  '数学': {
    practice: {
      ...
      sections: [
        ...
        { name: '探究进阶任务', note: '掌握、运用水平（会用数学的思维思考现实世界）：变式与综合运用，换情境、换数据、换设问角度，考查迁移' },
    ...
    errorbook: {
      ...
      sections: [
        { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
        { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
        { name: '错因剖析', note: '具体到知识点或思维环节（审题/建模/计算/验证），归因明确' },
        { name: '正确解答', note: '分步完整解答' },
        { name: '方法提炼', note: '归纳本类题通用策略' },
        { name: '变式训练', note: '1 道变式（换数据、换情境、换设问角度）' },
      ],
    },
    review: {
      label: '复习资料',
  ...
  '英语': {
    practice: {
      ...
      sections: [
        ...
        { name: '探究进阶任务', note: '应用实践类活动（描述与阐释、分析与判断、内化与运用）：语篇语境中的综合运用，变式设问' },
    ...
    errorbook: {
      ...
      sections: [
        { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
        { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
        { name: '错因剖析', note: '具体到知识点或思维环节（词汇/语法/语篇理解），归因明确' },
        { name: '正确解答', note: '分步完整解答' },
        { name: '方法提炼', note: '归纳本类题通用策略' },
        { name: '变式训练', note: '1 道变式（换语境、换情境、换设问角度）' },
      ],
    },
    review: {
      label: '复习资料',
  ...
  '科学': {
    practice: {
      ...
      sections: [
        ...
        { name: '探究进阶任务', note: '探究实践层（提出问题→作出假设→设计方案→观察记录→得出结论）：观察与实验任务，变式设问，考查迁移' },
    ...
    errorbook: {
      ...
      sections: [
        { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
        { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
        { name: '错因剖析', note: '具体到知识点或思维环节（概念/实验操作/现象解释），归因明确' },
        { name: '正确解答', note: '分步完整解答' },
        { name: '方法提炼', note: '归纳本类题通用策略' },
        { name: '变式训练', note: '1 道变式（换情境、换实验、换设问角度）' },
      ],
    },
    review: {
      label: '复习资料',
  ...
  '物理': {
    ...
    practice: {
      ...
      sections: [
        ...
        { name: '探究进阶任务', note: '科学探究层（方案→现象/数据→结论）：实验探究任务与变式练习，考查迁移' },
    ...
    errorbook: {
      ...
      sections: [
        { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
        { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
        { name: '错因剖析', note: '具体到知识点或思维环节（概念理解/审题建模/计算/实验操作），归因明确' },
        { name: '正确解答', note: '分步完整解答' },
        { name: '方法提炼', note: '归纳本类题通用策略' },
        { name: '变式训练', note: '1 道变式（换数据、换情境、换设问角度）' },
      ],
  ...
  '化学': {
    ...
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '科学探究与实践层（方案→现象→结论）：实验探究任务与变式练习，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（概念/化学用语/实验操作/计算），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换物质、换情境、换设问角度）' },
    ] },
  ...
  '生物': {
    ...
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '探究实践层（含变量控制）：实验探究任务与变式练习，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（概念/结构功能/实验/数据分析），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换情境、换图示、换设问角度）' },
    ] },
    review: { label: '复习资料', sections: [
  ...
  '历史': {
    ...
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '史料实证与历史解释层：材料分析任务（结合材料与所学），变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（史实/材料解读/论证），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换史料、换设问角度）' },
    ] },
    review: { label: '复习资料', sections: [
  ...
  '地理': {
    ...
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '综合思维层（要素综合→区域综合）：资料分析与区域综合任务，变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（概念/地图判读/要素分析），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换区域、换图表、换设问角度）' },
    ] },
    review: { label: '复习资料', sections: [
  ...
  '思想政治': {
    ...
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '科学精神层：材料分析任务（体现理论与材料、结论相互印证），变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（概念/材料解读/表述），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换情境、换设问角度）' },
    ] },
  ...
  '道德与法治': {
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '法治观念与健全人格层：案例与情境分析任务（做法＋理由），变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（概念/情境判断/表述），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换情境、换设问角度）' },
    ] },
  ...
  '信息科技': {
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '计算思维层（抽象→分解→算法→评估）：问题解决任务（算法/流程设计），变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（概念/操作/流程设计），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换场景、换数据、换设问角度）' },
    ] },
    review: { label: '复习资料', sections: [
  ...
  '音乐': {
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '艺术表现层（表现与创造）：表现与创作任务（演唱/节奏/创意），变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（乐理/听辨/表现），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换作品、换节奏、换设问角度）' },
    ] },
    review: { label: '复习资料', sections: [
  ...
  '美术': {
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '艺术表现层（表现与创造）：表现与创作任务（画/做/设计），变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（概念/赏析/表现），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换作品、换表现方式、换设问角度）' },
    ] },
    review: { label: '复习资料', sections: [
  ...
  '体育': {
    practice: { label: '同步练习', sections: [
      ...
      { name: '探究进阶任务', note: '运动能力运用层（运用与组合）：技能运用与组合任务，变式设问，考查迁移' },
    ...
    errorbook: { label: '易错题本', sections: [
      { name: '题目呈现', note: '呈现题目（保留关键信息，不省略题干）' },
      { name: '典型错解', note: '学生常见错误解法或答案，指出错在哪一步（真实高频错法，不杜撰）' },
      { name: '错因剖析', note: '具体到知识点或思维环节（要领/规则/安全），归因明确' },
      { name: '正确解答', note: '分步完整解答' },
      { name: '方法提炼', note: '归纳本类题通用策略' },
      { name: '变式训练', note: '1 道变式（换运动、换情境、换设问角度）' },
    ] },
    review: { label: '复习资料', sections: [
...
export const COLUMN_STYLE_SETS = {
  ...
  dictation: {
    ...
    d: { columns: ['默写过关', '好词好句', '一笔一画'] },
  },
  errorbook: {
    a: { columns: ['题目呈现', '典型错解', '错因剖析', '正确解答', '方法提炼', '变式训练'] },
    b: { columns: ['题目回放', '典型错例', '错因诊断', '规范解答', '方法归纳', '变式演练'] },
    c: { columns: ['题目复现', '常见误答', '错因定位', '正确步骤', '通法归纳', '举一反三'] },
    d: { columns: ['题目重现', '常见错法', '为何出错', '怎样改对', '通用思路', '再练一道'] },
  },
  review: {
    a: { columns: ['知识框架', '核心知识梳理', '典型题析', '易错聚焦', '综合自测'] },
    b: { columns: ['结构导图', '要点系统梳理', '典例精析', '误区聚焦', '分层自测'] },
    c: { columns: ['网络梳理', '核心知识精讲', '例题剖析', '易错警示', '自我检测'] },
...
export function buildTeachingInjection({ genType = '', stage = '', subject = '', columnStyle = '' } = {}) {
  ...
  return `\n\n【本次栏目（作大类标题用；${bp.custom ? `${bp.subject}·` : ''}${bp.label}·${TEACHING_STAGE_NAMES[bp.stageKey] || bp.stageKey}）】
