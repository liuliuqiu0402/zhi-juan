...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  ...
  '化学': {
    ...
    stages: {
      middle: { note: '2022义教化学课程理念（化学启蒙、联系生产生活实际）：以生活与实验现象为情境，注重化学用语规范与实验安全；实验任务含方案、现象、数据、结论' },
      high: { note: '高中化学课程理念（宏观辨识与微观探析、变化观念与平衡思想）：以真实情境（材料/能源/环境/工艺流程）为载体，设问有层次；实验任务重方案设计与证据推理' },
    },
  ...
  '生物': {
    ...
    stages: {
      middle: { note: '2022义教生物课程理念（生命观念、健康生活）：以图表/生活情境为载体，注重结构与功能关联；实验任务含变量控制与结论' },
      high: { note: '高中生物课程理念（生命观念/科学思维）：以图表情境为载体，设问有层次；实验任务重方案设计与数据分析' },
    },
    practice: { label: '课时练', sections: [
  ...
  '历史': {
    ...
    stages: {
      middle: { note: '2022义教历史课程理念（唯物史观、史料实证）：以时间轴/地图/史料为载体，材料题论从史出' },
      high: { note: '高中历史课程理念（历史解释/史料实证）：史料辨析与多角度解释，论述题观点明确、论证严谨' },
    },
    practice: { label: '课时练', sections: [
  ...
  '地理': {
    ...
    stages: {
      middle: { note: '2022义教地理课程理念（人地协调观、区域认知）：以地图/图表为载体，综合题沿区域定位→要素分析→人地关系' },
      high: { note: '高中地理课程理念（综合思维/区域认知）：区域与要素综合分析，图表信息解读有层次' },
    },
    practice: { label: '课时练', sections: [
  ...
  '思想政治': {
    ...
    stages: {
      high: { note: '高中思想政治课程理念（政治认同/科学精神/法治意识/公共参与）：以时政与生活情境为载体，材料分析沿原理→材料→结论，论述观点明确、分层论证' },
    },
    practice: { label: '课时练', sections: [
