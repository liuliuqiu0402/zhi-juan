...
export const TEACHING_BLUEPRINTS = {
  ...
  practice: {
    label: '课时练',
    sections: [
      { name: '基础建构任务', note: '覆盖本课时全部核心知识点，基础内容为主，各题/任务在情境中完整可作答' },
      { name: '探究进阶任务', note: '变式与综合运用，换情境、换角度、换设问，考查迁移运用，各题/任务步骤清晰' },
      { name: '迁移创新任务', note: '开放性/实践性内容，联系真实生活，设问指向真实思维' },
    ],
    stages: {
  ...
  reading: {
    ...
    sections: [
      ...
      { name: '分层设题', note: '设问由浅入深、指向理解运用与整体感受，题目不可直接在原文找到现成字面答案' },
    ],
    stages: {
  ...
  dictation: {
    ...
    sections: [
      ...
      { name: '积累内容', note: '严格对应教材要求，覆盖全部要求掌握的内容，按学段体现层次' },
