...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  ...
  '化学': {
    ...
    stages: {
      middle: { note: '2022义教化学学科核心素养（化学观念/科学思维/科学探究与实践/科学态度与责任）：以生活与实验现象为情境，注重化学用语规范与实验安全；实验任务含方案、现象、数据、结论' },
  ...
  '生物': {
    ...
    stages: {
      middle: { note: '2022义教生物学科核心素养（生命观念/科学思维/探究实践/态度责任）：以图表/生活情境为载体，注重结构与功能关联；实验任务含变量控制与结论' },
  ...
  '历史': {
    ...
    stages: {
      middle: { note: '2022义教历史学科核心素养（唯物史观/时空观念/史料实证/历史解释/家国情怀）：以时间轴/地图/史料为载体，材料题论从史出' },
  ...
  '地理': {
    ...
    stages: {
      middle: { note: '2022义教地理学科核心素养（人地协调观/综合思维/区域认知/地理实践力）：以地图/图表为载体，综合题沿区域定位→要素分析→人地关系' },
