 ...
 *   - 栏目语义定位用课标活动类型（学习理解→应用实践→迁移创新；感知体验→理解运用→综合创新），
 *     使活动类型归属可核对，模型按活动类型组织内容而非按题型切分；
 ...
 *     栏目语义挂各科各科核心素养（语文：学习理解/应用实践/迁移创新；数学：了解理解→掌握运用→综合运用；
 *     科学：科学观念/探究实践/态度责任；物理化学：观念；生物：生命观念；史地政/道德与法治/信息科技：
 *     各科观念与素养；音乐美术：审美感知/艺术表现/创意实践与文化理解；体育：运动能力/健康行为与体育品德）。
 *
...
export const TEACHING_BLUEPRINTS = {
  ...
  practice: {
    label: '同步练习',
    sections: [
      { name: '基础建构', note: '基于语篇的语言实践活动（感知与注意、获取与梳理、概括与整合）' },
      { name: '探究进阶', note: '深入语篇的语言实践活动（描述与阐释、分析与判断、内化与运用）' },
      { name: '迁移创新', note: '超越语篇的语言实践活动（推理与论证、批判与评价、想象与创造）' },
    ],
    stages: {
      primary_low: { volume: '6-9题', note: '以感知与体验为主：认读、口答、圈画等方式' },
      primary_mid: { volume: '8-12题', note: '以理解与运用为主：内容在语境中呈现，书写与表达适度兼顾' },
      primary_high: { volume: '10-15题', note: '以综合运用与初步创新为主：增加开放性题目，鼓励多角度思考与表达' },
      middle: { volume: '8-12题', note: '以探究与实践为主：题目含过程性要求，步骤完整、书写规范' },
      high: { volume: '10-15题', note: '以迁移与创新为主：题目指向综合运用' },
    },
  },
  ...
  special: {
    ...
    stages: {
      primary_low: { volume: '每板块3-4题，2-3板块', note: '以感知与体验为主：题目短小，便于口头作答' },
  ...
  preview: {
    ...
    sections: [
      ...
      { name: '预习指引', note: '形式由你按内容自定（圈画/概括/查阅/尝试），每项给做法与完成标准，可操作可检查，本次范围的新知识点都涉及到' },
    ...
    stages: {
      primary_low: { volume: '检测2-3题', note: '以感知与体验为主：以圈画、观察、口答等方式为主' },
      primary_mid: { volume: '检测3-4题', note: '以理解与运用为主：题目含尝试作答与查资料，检测量适中' },
      primary_high: { volume: '检测4-5题', note: '以综合运用与初步创新为主：题目含自主梳理，鼓励带着疑问进课堂' },
      middle: { volume: '检测4-5题', note: '以探究与实践为主：题目含自主查阅与概括，指向重难点' },
      high: { volume: '检测4-6题', note: '以迁移与创新为主：题目指向重难点与前置知识衔接' },
    },
  },
...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  '语文': {
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '识字与写字、语言文字积累与梳理（语言文字积累与梳理学习任务群）：涉及本次范围核心字词句段知识，围绕识字与写字、阅读与鉴赏、表达与交流、梳理与探究四类语文实践活动组织（按本次范围内容取适用类项），在语境中考查' },
        { name: '探究进阶', note: '阅读与鉴赏、表达与交流：语段阅读与表达运用' },
        { name: '迁移创新', note: '表达与交流、梳理与探究：口语表达或写话，联系本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
    ...
    preview: {
      ...
      sections: [
        ...
        { name: '预习指引', note: '问题驱动（读课文、圈画生字词、尝试朗读、质疑），可操作可检查，本课新知都涉及到' },
  ...
  '数学': {
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '了解、理解本次范围核心知识点（会用数学的眼光观察现实世界），在情境中考查' },
        { name: '探究进阶', note: '掌握、运用本次范围核心知识点（会用数学的思维思考现实世界）' },
        { name: '迁移创新', note: '综合运用与问题解决（会用数学的语言表达现实世界）：问题解决，结合本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
    ...
    preview: {
      ...
      sections: [
        ...
        { name: '预习指引', note: '问题驱动（阅读课本、尝试例题、圈画疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
      ],
    ...
    reading: {
      ...
      sections: [
        ...
        { name: '文本设题', note: '设问考查理解与应用；并给出具体做法与自查/完成标准' },
      ],
    },
    summary: {
      label: '知识总结',
  ...
  '英语': {
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '基于语篇的语言实践活动（感知与注意、获取与梳理、概括与整合）：涉及本次范围核心内容，在情境中呈现' },
        { name: '探究进阶', note: '深入语篇的语言实践活动（描述与阐释、分析与判断、内化与运用）：语篇语境中的综合运用' },
        { name: '迁移创新', note: '超越语篇的语言实践活动（推理与论证、批判与评价、想象与创造）：真实交际运用（情境对话、介绍、交流），联系本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
    ...
    preview: {
      ...
      sections: [
        ...
        { name: '预习指引', note: '问题驱动（听读课文、圈画生词、尝试跟读、记录疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
      ],
    ...
    reading: {
      ...
      sections: [
        ...
        { name: '文本设题', note: '设问题目不可直接在原文找到原句答案；并给出具体做法与自查/完成标准' },
      ],
    },
    summary: {
      label: '知识总结',
  ...
  '科学': {
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '科学观念（核心概念理解与辨识）：涉及本次范围核心知识点，结合生活现象与观察呈现；核心概念须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械记忆或仅作情境背景代替概念考查' },
        { name: '探究进阶', note: '探究实践（提出问题→作出假设→设计方案→观察记录→得出结论）：观察与实验题目' },
        { name: '迁移创新', note: '态度责任（科学应用与社会责任）：生活应用与实践题目（观察自然、制作模型、调查记录），联系本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
    ...
    preview: {
      ...
      sections: [
        { name: '学习目标', note: '明确本次范围要达成的核心目标' },
        { name: '预习指引', note: '问题驱动（阅读课本、观察身边事物、尝试实验准备、记录疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
      ],
  ...
  '物理': {
    ...
    stages: {
      ...
      high: { note: '注重物理观念与科学思维（高中物理学科核心素养）：以真实复杂情境为载体；实验题目含方案设计与数据分析；解答过程完整、逻辑严谨' },
    },
    practice: {
      label: '同步练习',
      sections: [
        { name: '基础建构', note: '物理观念：涉及本次范围概念、规律与公式，以生活与实验现象为情境；概念、规律与公式须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械套公式或仅作情境背景代替概念考查' },
        { name: '探究进阶', note: '科学探究（方案→现象/数据→结论）：实验探究题目' },
        { name: '迁移创新', note: '科学思维与态度责任：问题解决（生活、科技、工程应用），含作图与计算' },
      ],
    },
    special: {
      label: '专项突破',
    ...
    preview: {
      ...
      sections: [
        { name: '学习目标', note: '明确本次范围要达成的核心目标' },
        { name: '预习指引', note: '问题驱动（阅读课本、观察生活现象、尝试解释、记录疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
      ],
  ...
  '化学': {
    ...
    stages: {
      middle: { note: '2022年版义务教育化学课标核心素养（化学观念/科学思维/科学探究与实践/科学态度与责任）：以生活与实验现象为情境，注重化学用语规范与实验安全；实验题目含方案、现象、数据、结论' },
      high: { note: '高中化学学科核心素养（宏观辨识与微观探析/变化观念与平衡思想/证据推理与模型认知）：以真实情境（材料/能源/环境/工艺流程）为载体；实验题目重方案设计与证据推理' },
    },
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '化学观念：涉及本次范围元素、化学式、方程式等核心内容，在情境中考查；概念与化学用语须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械默写或仅作情境背景代替概念考查' },
      { name: '探究进阶', note: '科学探究与实践（方案→现象→结论）：实验探究题目' },
      { name: '迁移创新', note: '科学态度与责任：生产生活应用（材料、能源、环境），含化学用语规范书写' },
    ] },
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、观察生活现象、尝试实验准备、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '生物': {
    ...
    stages: {
      middle: { note: '2022年版义务教育生物课标核心素养（生命观念/科学思维/探究实践/态度责任）：以图表/生活情境为载体，注重结构与功能关联；实验题目含变量控制与结论' },
      high: { note: '高中生物学科核心素养（生命观念/科学思维）：以图表情境为载体；实验题目重方案设计与数据分析' },
    },
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '生命观念：涉及本次范围概念、结构与功能等核心内容，在图示情境中考查；概念、结构与功能须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械背诵或仅作情境背景代替概念考查' },
      { name: '探究进阶', note: '探究实践（含变量控制）：实验探究题目' },
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、观察身边生物、尝试实验准备、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '历史': {
    ...
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '时空观念：涉及本次范围史实、时间、人物等核心内容，在时间轴/地图情境中考查' },
      { name: '探究进阶', note: '史料实证与历史解释：材料分析题目（结合材料与所学）' },
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、梳理时间线索、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
    reading: { label: '阅读训练', sections: [
      ...
      { name: '文本设题', note: '设问答案须由材料与所学结合得出；并给出具体做法与自查/完成标准' },
    ] },
    summary: { label: '知识总结', sections: [
  ...
  '地理': {
    ...
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '区域认知：涉及本次范围地理要素与区域等核心内容，在地图情境中考查' },
      { name: '探究进阶', note: '综合思维（要素综合→区域综合）：资料分析与区域综合题目' },
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、观察地图与生活现象、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '思想政治': {
    ...
    stages: {
      high: { note: '高中思想政治学科核心素养（政治认同/科学精神/法治意识/公共参与）：以时政与生活情境为载体，材料分析体现理论与材料、结论的相互印证，论述观点明确、论证充分' },
    },
    practice: { label: '同步练习', sections: [
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、关注时政、尝试分析、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '道德与法治': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '道德修养：涉及本次范围行为规范与道德知识等核心内容，在情境辨析中考查' },
      { name: '探究进阶', note: '法治观念与健全人格：案例与情境分析题目（做法＋理由）' },
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '信息科技': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '信息意识：涉及本次范围概念与原理等核心内容，在应用场景中考查；概念与原理须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械记忆或仅作情境背景代替概念考查' },
      { name: '探究进阶', note: '计算思维（抽象→分解→算法→评估）：问题解决题目（算法/流程设计）' },
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、体验身边应用、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '音乐': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '审美感知（感知与体验）：涉及本次范围乐理与音乐要素等核心内容，在听辨情境中考查' },
      { name: '探究进阶', note: '艺术表现（表现与创造）：表现与创作题目（演唱/节奏/创意）' },
      { name: '迁移创新', note: '创意实践与文化理解（联系与拓展）：音乐欣赏与生活联系，联系本单元主题' },
    ] },
    special: { label: '专项突破', sections: [
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（聆听作品、阅读课本、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '美术': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '审美感知（感知与体验）：涉及本次范围造型/色彩/构图等核心内容，结合实例考查' },
      { name: '探究进阶', note: '艺术表现（表现与创造）：表现与创作题目（画/做/设计）' },
      { name: '迁移创新', note: '创意实践与文化理解（联系与拓展）：欣赏评述与生活应用，联系本单元主题' },
    ] },
    special: { label: '专项突破', sections: [
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（观察作品、阅读课本、尝试表现、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
  ...
  '体育': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '运动能力（认知与学练）：涉及本次范围动作要领与规则等核心内容，在运动情境中考查' },
      { name: '探究进阶', note: '运动能力（运用与组合）：技能运用与组合题目' },
      { name: '迁移创新', note: '健康行为与体育品德（迁移与拓展）：锻炼习惯与安全健康，联系本单元主题' },
    ] },
    special: { label: '专项突破', sections: [
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '问题驱动（阅读课本、观察动作示范、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
