...
export const TEACHING_BLUEPRINTS = {
  ...
  reading: {
    label: '阅读训练',
    sections: [
      { name: '原创选文', note: '原创短文（不复制课文/网络文章），课外选文主题须与单元相关，短文完整呈现（不截断）' },
      { name: '分层设题', note: '分层设题，设问由浅入深，题目不可直接在原文找到原句答案' },
    ],
    stages: {
  ...
  summary: {
    ...
    sections: [
      ...
      { name: '易错辨析', note: '列出易错点并辨析' },
      { name: '典型例题', note: '典型例题（含解析）' },
    ],
    stages: {
  ...
  review: {
    ...
    sections: [
      ...
      { name: '典型题析', note: '典型题（含解题思路分析）' },
      { name: '易错聚焦', note: '易错点辨析' },
