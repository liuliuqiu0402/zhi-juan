 ...
 *   - 栏目语义可挂课标活动类型/素养名，但**只作内容归属的语义锚，不规定内容组织方式**——
 *     课标的活动类型是"描述学生做什么"，不是"栏目分类标准"（2026-09-17 用户裁定）；
 *   - 学段 note 直接给该学段的操作形态描述：原「以感知与体验→理解与运用→综合运用与初步创新→探究与实践→迁移与创新」
 *     五档起头语经 2026-09-17 核查**非任何课标口径**（艺术/科学/英语课标术语拼接的产品自造，且误把"活动类型/素养维度"当"学段档位"），已整批删除；
 *   - 学科专属蓝图在各科课标（2022 义教 / 2017 高中）框架下按 学科×类型×学段 对齐，
 *     栏目语义挂各科核心素养（语文＝识字与写字/阅读与鉴赏/表达与交流/梳理与探究（四类语文实践活动）；数学＝了解/理解/掌握/运用（结果目标行为动词）；
 *     科学＝科学观念/科学思维/探究实践/态度责任；物理＝物理观念/科学思维/科学探究/科学态度与责任；化学＝化学观念/科学思维/科学探究与实践/科学态度与责任；生物＝生命观念/科学思维/探究实践/态度责任；
 *     历史＝唯物史观/时空观念/史料实证/历史解释/家国情怀；地理＝人地协调观/综合思维/区域认知/地理实践力；道德与法治＝政治认同/道德修养/法治观念/健全人格/责任意识；
 *
 *     思想政治（高中）＝政治认同/科学精神/法治意识/公共参与；信息科技＝信息意识/计算思维/数字化学习与创新/信息社会责任；音乐美术＝审美感知/艺术表现/创意实践/文化理解；体育＝运动能力/健康行为/体育品德）。
...
export const TEACHING_BLUEPRINTS = {
  ...
  practice: {
    ...
    stages: {
      primary_low: { volume: '6-9题', note: '认读、口答、圈画等方式' },
      primary_mid: { volume: '8-12题', note: '内容在语境中呈现，书写与表达适度兼顾' },
      primary_high: { volume: '10-15题', note: '增加开放性题目，鼓励多角度思考与表达' },
      middle: { volume: '8-12题', note: '题目含过程性要求，步骤完整、书写规范' },
  ...
  special: {
    ...
    stages: {
      ...
      primary_high: { volume: '每板块4-5题，3-4板块', note: '含变式与开放设问' },
      middle: { volume: '每板块3-5题，3-4板块', note: '含过程性设问，注重步骤与推理' },
      high: { volume: '每板块4-6题，3-5板块', note: '设问有区分度，指向综合运用' },
    },
  },
  ...
  preview: {
    ...
    stages: {
      primary_low: { volume: '检测2-3题', note: '以圈画、观察、口答等方式为主' },
  ...
  dictation: {
    ...
    stages: {
      ...
      middle: { volume: '基础内容12-16条', note: '内容在语境中考查，含易错辨析' },
...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  '语文': {
    ...
    preview: {
      ...
      sections: [
        ...
        { name: '预习指引', note: '形式由你按内容自定（读课文、圈画生字词、尝试朗读、质疑），可操作可检查，本课新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
      ],
    },
    reading: {
      label: '阅读训练',
  ...
  '数学': {
    ...
    preview: {
      ...
      sections: [
        ...
        { name: '预习指引', note: '形式由你按内容自定（阅读课本、尝试例题、圈画疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
      ],
  ...
  '英语': {
    ...
    preview: {
      ...
      sections: [
        ...
        { name: '预习指引', note: '形式由你按内容自定（听读课文、圈画生词、尝试跟读、记录疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
      ],
  ...
  '科学': {
    ...
    preview: {
      ...
      sections: [
        { name: '学习目标', note: '明确本次范围要达成的核心目标' },
        { name: '预习指引', note: '形式由你按内容自定（阅读课本、观察身边事物、尝试实验准备、记录疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
      ],
  ...
  '物理': {
    ...
    preview: {
      ...
      sections: [
        { name: '学习目标', note: '明确本次范围要达成的核心目标' },
        { name: '预习指引', note: '形式由你按内容自定（阅读课本、观察生活现象、尝试解释、记录疑问），可操作可检查，本次范围的新知都涉及到' },
        { name: '预习检测', note: '自检题检测预习效果' },
        { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
        { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
      ],
  ...
  '化学': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、观察生活现象、尝试实验准备、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '生物': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、观察身边生物、尝试实验准备、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '历史': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、梳理时间线索、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '地理': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、观察地图与生活现象、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '思想政治': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、关注时政、尝试分析、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '道德与法治': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '道德修养：涉及本次范围行为规范与道德知识等核心内容，在材料辨析中考查' },
      { name: '探究进阶', note: '法治观念与健全人格：案例与材料分析题目（做法＋理由）' },
      { name: '迁移创新', note: '责任意识：生活实践与社会参与，联系本单元主题' },
    ] },
    special: { label: '专项突破', sections: [
      { name: '分板块组织', note: '按本单元内容分板块（道德规范/法治常识/材料辨析）；并给出具体做法与自查/完成标准' },
      { name: '每板块配解析', note: '每板块适量题目并附解析，聚焦本单元薄弱点' },
    ] },
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '信息科技': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、体验身边应用、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '音乐': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（聆听作品、阅读课本、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '美术': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（观察作品、阅读课本、尝试表现、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
  ...
  '体育': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '运动能力（运动认知与技战术运用）：涉及本次范围动作要领与规则等核心内容，在运动情境中考查' },
      { name: '探究进阶', note: '运动能力（体育展示或比赛）：技能运用与组合题目' },
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习指引', note: '形式由你按内容自定（阅读课本、观察动作示范、记录疑问），可操作可检查，本次范围的新知都涉及到' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '课后问答', note: '教材中供思考、讨论作答的问题类内容原样引用教材原题，并配预读与尝试作答要求；无此类内容或未提供原文时省略，不得自行编造' },
      { name: '我的疑问', note: '须包含此项，供学生记录预习中不懂的问题' },
    ] },
