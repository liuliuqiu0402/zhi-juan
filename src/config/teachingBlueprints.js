...
export const TEACHING_BLUEPRINTS = {
  ...
  practice: {
    label: '课时练',
    sections: [
      { name: '基础建构任务', note: '学习理解类活动（感知与注意、获取与梳理、概括与整合）：覆盖本课时全部核心知识，基础内容为主，各题/任务在情境中完整可作答' },
  ...
  preview: {
    ...
    sections: [
      ...
      { name: '预习任务', note: '分层（由浅入深：感知体验→理解建构→尝试运用），问题驱动（圈画/概括/查阅/尝试），每任务给做法与完成标准，可操作可检查，覆盖本课时全部新知识点' },
  ...
  dictation: {
    ...
    stages: {
      primary_low: { volume: '基础内容4-8条', note: '以感知与体验为主：以本课时/单元核心内容为主，量小而精' },
  ...
  errorbook: {
    ...
    stages: {
      ...
      primary_mid: { volume: '5-8题', note: '以理解与运用为主：归因明确，变式贴近原题' },
...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  '语文': {
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '学习理解层（识字与写字、语言积累与梳理）：覆盖本课时核心字词句段知识，围绕识字与写字、阅读与鉴赏、表达与交流、梳理与探究四类语文实践活动组织（按本课时内容取适用类项），在语境中考查' },
  ...
  '数学': {
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '了解、理解水平（会用数学的眼光观察现实世界）：覆盖本课时核心知识点，在情境中考查' },
  ...
  '英语': {
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '学习理解类活动（感知与注意、获取与梳理、概括与整合）：覆盖本课时核心内容，在情境中呈现' },
  ...
  '科学': {
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '科学观念层（核心概念理解与辨识）：覆盖本课时核心知识点，结合生活现象与观察呈现；核心概念须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械记忆或仅作任务背景代替概念考查' },
  ...
  '物理': {
    ...
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '物理观念层：覆盖本课时概念、规律与公式，以生活与实验现象为情境；概念、规律与公式须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械套公式或仅作任务背景代替概念考查' },
  ...
  '化学': {
    ...
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '化学观念层：覆盖本课时元素、化学式、方程式等核心内容，在情境中考查；概念与化学用语须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械默写或仅作任务背景代替概念考查' },
  ...
  '生物': {
    ...
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '生命观念层：覆盖本课时概念、结构与功能等核心内容，在图示情境中考查；概念、结构与功能须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械背诵或仅作任务背景代替概念考查' },
  ...
  '历史': {
    ...
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '时空观念与史实理解层：覆盖本课时史实、时间、人物等核心内容，在时间轴/地图情境中考查' },
  ...
  '地理': {
    ...
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '区域认知层：覆盖本课时地理要素与区域等核心内容，在地图情境中考查' },
  ...
  '思想政治': {
    ...
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '政治认同与概念理解层：覆盖本课时概念与原理等核心内容，在情境中考查' },
  ...
  '道德与法治': {
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '道德修养与认知层：覆盖本课时行为规范与道德知识等核心内容，在情境辨析中考查' },
  ...
  '信息科技': {
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '信息意识与概念理解层：覆盖本课时概念与原理等核心内容，在应用场景中考查；概念与原理须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械记忆或仅作任务背景代替概念考查' },
  ...
  '音乐': {
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '审美感知层（感知与体验）：覆盖本课时乐理与音乐要素等核心内容，在听辨情境中考查' },
  ...
  '美术': {
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '审美感知层（感知与体验）：覆盖本课时造型/色彩/构图等核心内容，结合实例考查' },
  ...
  '体育': {
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '运动能力层（认知与学练）：覆盖本课时动作要领与规则等核心内容，在运动情境中考查' },
