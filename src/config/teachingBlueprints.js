...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  ...
  '物理': {
    ...
    practice: {
      ...
      sections: [
        ...
        { name: '迁移创新', note: '科学思维、科学态度与责任：问题解决（生活、科技、工程应用），含作图与计算' },
      ],
    },
    special: {
      label: '专项突破',
  ...
  '音乐': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '审美感知（欣赏）：涉及本次范围乐理与音乐要素等核心内容，在听辨情境中考查' },
      { name: '探究进阶', note: '艺术表现（表现）：表现与创作题目（演唱/节奏/创意）' },
  ...
  '美术': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '审美感知（欣赏·评述）：涉及本次范围造型/色彩/构图等核心内容，结合实例考查' },
      { name: '探究进阶', note: '艺术表现（造型·表现）：表现与创作题目（画/做/设计）' },
  ...
  '体育': {
    practice: { label: '同步练习', sections: [
      { name: '基础建构', note: '运动能力（体能、运动认知与技战术运用）：涉及本次范围动作要领与规则等核心内容，在运动情境中考查' },
      { name: '探究进阶', note: '运动能力（技战术运用与展示）：技能运用与组合题目' },
      { name: '迁移创新', note: '健康行为与体育品德（锻炼习惯与健康知识技能、体育精神与品格）：锻炼习惯与安全健康，联系本单元主题' },
    ] },
    special: { label: '专项突破', sections: [
