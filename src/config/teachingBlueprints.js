...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  '语文': {
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '覆盖本课时核心知识点，围绕识字与写字、阅读与鉴赏、表达与交流、梳理与探究四类语文实践活动组织（按本课时内容取适用类项），在语境中考查' },
  ...
  '科学': {
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '覆盖本课时核心知识点，结合生活现象与观察呈现；核心概念须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械记忆或仅作任务背景代替概念考查' },
  ...
  '物理': {
    ...
    practice: {
      label: '课时练',
      sections: [
        { name: '基础建构任务', note: '覆盖本课时概念、规律与公式，以生活与实验现象为情境；概念、规律与公式须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械套公式或仅作任务背景代替概念考查' },
  ...
  '化学': {
    ...
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '覆盖本课时元素、化学式、方程式等核心内容，在情境中考查；概念与化学用语须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械默写或仅作任务背景代替概念考查' },
  ...
  '生物': {
    ...
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '覆盖本课时概念、结构与功能等核心内容，在图示情境中考查；概念、结构与功能须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械背诵或仅作任务背景代替概念考查' },
  ...
  '信息科技': {
    practice: { label: '课时练', sections: [
      { name: '基础建构任务', note: '覆盖本课时概念与原理等核心内容，在应用场景中考查；概念与原理须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械记忆或仅作任务背景代替概念考查' },
