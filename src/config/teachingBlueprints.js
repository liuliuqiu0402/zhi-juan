...
export const TEACHING_SUBJECT_BLUEPRINTS = {
  '语文': {
    practice: {
      ...
      sections: [
        ...
        { name: '迁移创新任务', note: '迁移创新层（表达与交流、梳理与探究）：生活化口语表达或写话，联系本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
  ...
  '数学': {
    practice: {
      ...
      sections: [
        ...
        { name: '迁移创新任务', note: '综合运用与问题解决（会用数学的语言表达现实世界）：真实问题解决，联系生活实际与本单元主题' },
      ],
    },
    special: {
      label: '专项突破',
  ...
  '道德与法治': {
    ...
    preview: { label: '预习导学', sections: [
      { name: '学习目标', note: '明确本次范围要达成的核心目标' },
      { name: '预习任务', note: '问题驱动（阅读课本、联系生活实际、记录疑问），可操作可检查，覆盖本次范围全部新知' },
      { name: '预习检测', note: '自检题检测预习效果' },
      { name: '我的疑问', note: '必设栏目，供学生记录预习中不懂的问题' },
    ] },
    reading: { label: '阅读训练', sections: [
