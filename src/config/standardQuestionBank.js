  ...
  '物理': {
    'middle': {
      ...
      '伏安法测电阻': {
        ...
        rule: '设问链固定：连接电路→滑片初始位置→电表读数→公式计算→变阻器作用→评估改进（真题实证：2023江苏盐城）；考查电阻必须标额定电压并据此选量程；禁止脱离实物图空问',
      },
      '测量小灯泡电功率': {
        ...
        score: '共8-10分，分步给分',
        rule: '额定功率取额定电压下数据（不取平均）；设问链固定（真题实证：中考高频）；禁止把额定功率算成三组平均值',
      },
      '探究欧姆定律': {
        ...
        score: '共8-10分',
        rule: '两关系滑动变阻器作用区分（I-U：改变电压；I-R：控制电压不变）是高频考点；设问链固定（真题实证：中考必考）',
      },
      '电学计算': {
        ...
        score: '共6-10分，分步设问递进',
        rule: '情境真实（电热水壶/电饭煲/吹风机等家用电器，真题实证：湖南电热水壶题）；铭牌额定值代入；禁止编造不合理数据（电流、功率需物理上合理）',
      },
      '家庭电路选择': {
        ...
        score: '每题2-3分',
        rule: '考查三孔插座接线/开关接火线/保险丝作用/触电防护/跳闸原因区分（真题实证：2024广东广州家庭电路故障题）；干扰项来自学生常见错误观念，禁止超纲',
      },
      '电功率选择': {
        ...
        score: '每空1-2分',
        rule: '考查串并联亮度比较（P=U²/R 与 P=I²R 定性判断，真题实证：湖南2024白炽灯题）；禁止脱离电路连接方式空问',
      },
      '电能表计算': {
        ...
        score: '每空1-2分，共4-6分',
        rule: '考查电能表读数/转盘计算/实际功率（真题实证：2022湖北十堰）；"3000r/kW·h"类参数必须明确给出；禁止把转数直接当电能',
      },
    },
  },
};
