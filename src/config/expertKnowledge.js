...
export const styleOptions = [
  ...
  { group: 'proposition', value: 'scenario_each', label: '逐题情境', desc: '每题独立真实适切情境',
    tip: '每题设置独立、真实适切的情境设问，不强制统一主题，灵活性最高；适用于日常训练类资料。',
    appliesTo: ['practice', 'special', 'reading'], required: false },
  { group: 'proposition', value: 'big_unit', label: '大单元教学', desc: '跨课时大概念组织',
    tip: '打破课时界限，围绕大概念/大任务整体设计，体现知识间的关联与递进；大单元教学是课标倡导的组织方式，适用于以单元/跨课时组织的训练。',
  ...
  { group: 'proposition', value: 'traditional', label: '传统题组', desc: '不设统一情境，按题组/板块组织',
    tip: '按传统教辅体例组织：不强制统一情境、不做任务化包装，以知识板块或题组为单位逐题命制，题目按本学科本学段通行形态设问、作答直接；适用于希望保留传统练习形态的场景（用户显式选择，非系统默认）。',
...
//    原 scenario_each「每题设置**贴近学生生活**的独立情境设问」与 context_chain「以一个**贴近生活**的大主题…」
//    属**产品自造的跨学科情境取向**——"贴近学生生活"把所有学科都推向"校园/家庭"，是情境同质的直接推力
//    （实证：两次独立生成的五个情境全是"参加学校活动/比赛→遇困难→被鼓励→尽力而为"）。
