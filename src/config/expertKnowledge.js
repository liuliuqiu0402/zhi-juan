...
export const subjectCoreCompetencies = {
  ...
  '信息科技': '信息意识、计算思维、数字化学习与创新、信息社会责任。命题应结合实际应用场景，考查学生运用信息科技解决问题的能力。',
  '信息技术': '信息意识、计算思维、数字化学习与创新、信息社会责任。命题应结合实际应用场景，考查学生运用信息科技解决问题的能力。',
  '音乐': '审美感知、艺术表现、文化理解、创意实践。命题应从音乐作品与生活情境中出发，考查听辨、表现与赏析能力。',
  '美术': '审美感知、艺术表现、创意实践、文化理解。命题应从视觉作品与生活情境中出发，考查观察、表现与赏析能力。',
  '体育': '运动能力、健康行为、体育品德。命题应从运动情境与健康生活出发，考查运动技能、健康认知与体育精神。',
  '体育与健康': '运动能力、健康行为、体育品德。命题应从运动情境与健康生活出发，考查运动技能、健康认知与体育精神。'
};
