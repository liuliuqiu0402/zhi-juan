...
export const DEFAULT_BUDGET_BY_TYPE = {
  ...
  summary:  { mode: 'auto', tier: 'balanced', body: { economy: 1.1, balanced: 1.6, full: 2.0, cap: 20000, custom: null }, answer: { economy: 0.6, balanced: 0.85, full: 1.1, cap: 10000, custom: null }, once: { economy: 1.7, balanced: 2.8, full: 4.0, cap: 36000, custom: null } },
  review:   { mode: 'auto', tier: 'balanced', body: { economy: 1.05, balanced: 1.5, full: 1.9, cap: 20000, custom: null }, answer: { economy: 0.5, balanced: 0.7, full: 0.95, cap: 10000, custom: null }, once: { economy: 1.55, balanced: 2.5, full: 3.7, cap: 36000, custom: null } },
  preview:  { mode: 'auto', tier: 'balanced', body: { economy: 1.45, balanced: 2.1, full: 2.7, cap: 12000, custom: null }, answer: { economy: 0.73, balanced: 1.05, full: 1.35, cap: 6000, custom: null }, once: { economy: 2.18, balanced: 3.6, full: 5.3, cap: 24000, custom: null } },
  dictation: { mode: 'auto', tier: 'balanced', body: { economy: 0.9, balanced: 1.3, full: 1.7, cap: 12000, custom: null }, answer: { economy: 0.46, balanced: 0.65, full: 0.85, cap: 6000, custom: null }, once: { economy: 1.36, balanced: 2.2, full: 3.3, cap: 20000, custom: null } },
  errorbook: { mode: 'auto', tier: 'balanced', body: { economy: 0.95, balanced: 1.4, full: 1.8, cap: 12000, custom: null }, answer: { economy: 0.5, balanced: 0.7, full: 0.95, cap: 6000, custom: null }, once: { economy: 1.45, balanced: 2.4, full: 3.6, cap: 20000, custom: null } },
};
