...
· 单位联动换算：换算须写成"数值×进率＝新数值＋新单位"（如 2.05 千米＝2050 米），数值与单位同步改变；同一命题内同一单位只能出现一个数值，禁止只改数字不改单位（如把 2.05 千米写成 205 千米）。
...
export const SUBJECT_STAGE_EXTRAS = {
  // ── 语文 ──
  '语文|primary_low': { text: '识字写字认读与书写并重、在语境中识记运用；口语交际敢说会听、乐于表达；写话有兴趣，写自己想说的话与想象中的事物。', source: '2022义教语文·第一学段识字与写字/表达与交流（口语交际与写话）+ 语言文字积累与梳理任务群' },
  '语文|primary_mid': { text: '词句在真实语境中理解运用；阅读能初步把握主要内容、体会思想感情；习作乐于书面表达，观察周围世界，不拘形式写下见闻与想象。', source: '2022义教语文·第二学段阅读与鉴赏/表达与交流（初步把握主要内容、乐于书面表达）' },
  ...
  '英语|primary_high': { text: '语篇阅读与书面表达结合主题语境；围绕主题表达清楚、有条理。', source: '2022义教英语·核心素养（语言能力/思维品质）' },
