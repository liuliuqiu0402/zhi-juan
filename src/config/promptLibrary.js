...
export const SUBJECT_STAGE_EXTRAS = {
  ...
  '数学|primary_mid': { text: '计算与竖式规范；概念与单位换算在情境中考查；实际问题真实情境、列式计算作答完整。', source: '2022义教数学·第二学段学段目标（较复杂整数运算、数量关系）' },
  '数学|primary_high': { text: '计算与方程在情境中运用；几何与统计结合操作；实际问题体现建模过程（理解→列式→计算→作答）。', source: '2022义教数学·第三学段学业质量描述（数感/符号意识/模型意识）' },
  '数学|middle': { text: '数与式、方程不等式、函数、几何、统计概率综合；解题过程完整（推理链清晰）；实际问题真实情境建模。', source: '2022义教数学·第四学段学段目标（数与式/方程与不等式/函数）+ 推理能力核心素养' },
  '数学|high': { text: '函数与导数、几何、概率统计综合；解题过程完整、逻辑严谨、步骤规范；开放设问考查数学表达与推理。', source: '高中数学课标(2017/2020)·必修内容 + 核心素养（数学抽象/逻辑推理/数学建模/直观想象/数学运算/数据分析）' },
  // ── 英语 ──
