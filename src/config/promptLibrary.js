...
export const SUBJECT_STAGE_EXTRAS = {
  ...
  // ── 数学 ──
  '数学|primary_low': { text: '口算与简单应用结合生活情境；图形与量以直观操作呈现；问题解决列式、计算、作答完整；概念、法则与规律须显性考查其理解（能辨识含义、适用条件与易混区别），不以机械套算或仅作任务背景代替概念考查。', source: '2022义教数学·第一学段学段目标（数的抽象、整数四则运算、长度测量）+ 2022义教数学命题建议（注重考查数学本质的理解，避免机械训练）' },
