...
export const SUBJECT_STAGE_EXTRAS = {
  ...
  // ── 物理 ──
  '物理|middle': { text: '实验探究体现完整过程；计算题真实情境建模（画示意→列式→计算→作答）；设问以生活/实验现象为载体。', source: '2022义教物理·课程理念（从生活走向物理）+ 核心素养（物理观念/科学思维/科学探究/科学态度与责任）' },
  ...
  '科学|primary_mid': { text: '实验探究含猜想、方案、现象、结论；设问结合生活现象。', source: '2022义教科学·核心素养（科学观念/科学思维/探究实践/态度责任）' },
