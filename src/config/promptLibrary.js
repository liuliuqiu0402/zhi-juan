...
export const SUBJECT_STAGE_EXTRAS = {
  ...
  // ── 音乐 ──
  '音乐|primary_low': { text: '音的高低长短、节奏快慢以情境设问；表现题可用圈选/连线/涂色呈现。', source: '2022义教艺术(音乐)·课程理念（重视艺术体验）' },
...
export const STAGE_EXAM_EXTRAS = {
  primary_low: { text: '情境游戏化（开火车/闯关/情景剧场）；字号大、图文并茂，需配图处用 [IMAGE] 标记；难度低起点，多数学生能完成；认知底线：难度与情境符合低段认知水平，不出现未学概念与抽象符号。', source: '2022义教课程方案（注重幼小衔接，小学低年级注重活动化、游戏化、生活化的学习设计）+ 课标学业质量要求（不超学段）' },
