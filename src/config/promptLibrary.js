...
export const SUBJECT_STAGE_EXTRAS = {
  ...
  '英语|middle': { text: '语篇完整地道（真实语境、无中式英语）；书面表达给要点支架；设问由浅入深、有层次。', source: '2022义教英语·核心素养（语言能力/文化意识/思维品质/学习能力） + 命题质量要求（语篇真实地道、表达规范，为产品级表述，非课标原文）' },
  '英语|high': { text: '听力、阅读语篇真实地道；语言知识在语篇语境中考查；书面表达（应用文、读后续写等）设问清晰、给足信息。', source: '高中英语课标(2017/2020)·核心素养（语言能力/文化意识/思维品质/学习能力） + 学业质量与考试命题建议（书面表达题型含应用文、读后续写等）' },
  // ── 物理 ──
  ...
  // ── 信息科技 ──
  '信息科技|primary_low': { text: '设备认知与合理使用数字设备（合理安排使用时间、保护个人隐私）以情境设问；操作步骤描述清晰；1—2 年级该课程以融入方式实施。', source: '2022义教信息科技·第一学段学段目标（知道数字设备使用基本规范，合理安排使用时间养成好习惯）+ 内容模块（信息交流与分享/信息隐私与安全）' },
  ...
  '信息科技|middle': { text: '互联网应用与物联网结合场景；方案设计体现流程与方法、指向计算思维。', source: '2022义教信息科技·核心素养（信息意识/计算思维/数字化学习与创新/信息社会责任）' },
  '信息科技|high': { text: '数据与计算、信息系统结合真实任务；算法设计逻辑清晰。', source: '高中信息技术课标(2017/2020)·核心素养（信息意识/计算思维/数字化学习与创新/信息社会责任）' },
  // ── 音乐 ──
  '音乐|primary_low': { text: '音的高低长短、节奏快慢以情境设问；表现以贴合低段认知水平的方式呈现。', source: '2022义教艺术(音乐)·课程理念（重视艺术体验）' },
  ...
  '美术|primary_high': { text: '赏析结合中华优秀传统文化；设计应用类题有明确要求。', source: '2022义教艺术(美术)·核心素养（审美感知/艺术表现/创意实践/文化理解）' },
