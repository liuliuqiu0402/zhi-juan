...
export const SUBJECT_STAGE_EXTRAS = {
  ...
  // ── 英语 ──
  '英语|primary_low': { text: '词汇在图片/情境中识别与认读；以听说认读为主，书写正确规范。英文书写口径：句首与专有名词大写；用英文标点（句号用半角"."、撇号用半角"\u0027"），缩写与所有格撇号不丢（Let\u0027s/It\u0027s/children\u0027s）。', source: '2022义教英语·语言能力核心素养（感知与积累）' },
  '英语|primary_mid': { text: '词汇句型在语篇/情境中运用；书写规范。英文书写口径：句首与专有名词大写；用英文标点（句号用半角"."、撇号用半角"\u0027"），缩写与所有格撇号不丢（Let\u0027s/It\u0027s/children\u0027s）；美/英拼写与发音同卷不混用。', source: '2022义教英语·语言能力核心素养（习得与建构）' },
  '英语|primary_high': { text: '语篇阅读与书面表达结合主题语境；围绕主题表达清楚、有条理。英文书写口径：句首与专有名词大写；用英文标点（句号用半角"."、撇号用半角"\u0027"），缩写与所有格撇号不丢（Let\u0027s/It\u0027s/children\u0027s）；美/英拼写同卷不混用。', source: '2022义教英语·核心素养（语言能力/思维品质）' },
  '英语|middle': { text: '语篇完整地道（真实语境、无中式英语）；书面表达主题明确、意思连贯。', source: '2022义教英语·核心素养（语言能力/文化意识/思维品质/学习能力） + 命题质量要求（语篇真实地道、表达规范，为产品级表述，非课标原文）' },
  '英语|high': { text: '听力、阅读语篇真实地道；语言知识在语篇语境中理解运用；书面表达涵盖应用文、读后续写等类型。', source: '高中英语课标(2017/2020)·核心素养（语言能力/文化意识/思维品质/学习能力） + 学业质量与考试命题建议（书面表达题型含应用文、读后续写等）' },
  // ── 物理 ──
