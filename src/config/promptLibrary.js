...
· 内容正确：图文一致（配图/图形与题干严格吻合）；逻辑自洽（条件充分、因果清晰、设问与答案对应）；知识点与能力要求不超出本学段课标学业质量要求——材料载体可来自课外（主题相关、难度适切本学段）；全部内容围绕本单元主题与考点（知识锚定教材单元）`;
...
3. 每道题题干完整、可直接作答；所有题目原创设计，禁止照搬教材原题；内容充实饱满
