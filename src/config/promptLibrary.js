...
【创作要求】覆盖{unit}全部知识点并标注教材出处，不遗漏；重点标注、文字精炼；栏目与篇幅按生成时注入的【教辅结构】执行。
...
export const STAGE_EXAM_EXTRAS = {
  primary_low: { text: '情境活动化、游戏化、贴近生活（不出现具体游戏形式）；图文并茂；难度低起点，多数学生能完成；认知底线：难度与情境符合低段认知水平，不出现未学概念与抽象符号。', source: '2022义教课程方案（注重幼小衔接，小学低年级注重活动化、游戏化、生活化的学习设计）+ 课标学业质量要求（不超学段）' },
