      ...
      <div class="settings-section">
        ...
        <div style="margin-bottom:14px;background:#f0f7ff;border:1px solid #b3d4fc;border-radius:8px;padding:8px 12px;">
          ...
          <div style="font-size:11px;color:#888;margin-bottom:6px;line-height:1.5;">
            控制生成时教材素材如何进入指令：<b>自动</b>按资料类型默认（归纳/积累型→全文注入；命题/练习型→锚清单注入）；<b>全文</b>整章原文（直放/压缩）全部注入；<b>锚清单</b>仅【锚点清单】（含各知识点具体概念）+ 难度要求，不注入整章原文（抑制模型对教材原文的过度依赖）。需点「保存设置」生效。
          </div>
...
// 📚 素材通道三档（2026-09-14 用户定版）：auto 按资料类型默认 / full 全文注入 / anchor 锚清单注入
