...
必须返回以下JSON格式：
{
  ...
  "formulas": ["$公式$ → 含义"],
  "coreTopics": "核心主题词，逗号分隔（3-6个，按概括程度排序）",
  "knowledgeHierarchy": [
    {
...
- 📖 案例分析/材料解读/情境判断
- 📖 比较异同/归纳总结/评价论述
- 📖 ${isHistory ? '史料实证/历史解释/时空观念' : isGeography ? '区域认知/综合思维/人地协调观' : (isSenior ? '政治认同/科学精神/法治意识/公共参与（高中思想政治）' : '政治认同/道德修养/法治观念/健全人格/责任意识（道德与法治）')}
- 📖 课后练习/习题考查的知识范围与能力要求
- 🔒 必须逐条标注，绝不将多个知识点合并为一条
- 🔒 先通读确认段落整体内容类型，再逐条精准标注
