...
// ==================== 🔧 整卷生成（DeepSeek 云端主路径）====================
  ...
  const _runPaperOrder = async (params = {}) => {
    ...
    prompt += `\n\n【尾约束·全文自洽】
题干所声明的作答要素（作答处、载体、选项、题面所用素材）须在正文真实、足量、形式吻合地存在；素材依课标可取自教材之外的真实情境、不限所选教材，但题面引用或呈现的素材必须与本题实际给出的内容完全一致；正文不得先现待作答结论；正文对知识、要点、示例、数据、结论的归纳与转述须准确、完整、不遗漏、条理清晰，各题、各要点、各结论及其答案之间前后一致、互不矛盾。凡题干与正文不符，或内容漏错、自相矛盾，即为无效内容，须于定稿前修正。`;
